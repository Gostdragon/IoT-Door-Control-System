...
class FileFormatException(SemanticsException):
    ...
    def __init__(self, errorMessage: str):
        ...
        Erstellt und initialisiert eine Semantik-Exception, die auf einen Fehler
...
class LogException(Exception):
    ...
    Methods:
        __init__: Konstruktor der Klasse :class:`~exceptions.SemanticsException`.
    """
...
class NotImplementedException(Exception):
    """
    Diese Exception wird verwendet, um beim Aufruf von noch nicht fertig implementiertem Code eine Fehlermeldung auszugeben
    Methods:
        __init__: Konstruktor der Klasse NotImplementedException
    """

    def __init__(self, error_message: str):
        """
        Kontruktor, um eine NotImplementedException zu erzeugen

        :param error_message: Die konkrete Fehlernachricht, die beim Werfen dieser Exception ausgegeben werden soll
        :type error_message: str
        """
        super().__init__(error_message)
